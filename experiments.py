...
df = pd.DataFrame({'Klasyfikator': ['LR', 'DT', 'GaussianNB', 'KNN', 'RL SKlearn'],
                   'Dokładność': [mean_scores[0], mean_scores[1], mean_scores[2], mean_scores[3], mean_scores[4]],
                   'Precyzja': [mean_scores_2[0], mean_scores_2[1], mean_scores_2[2], mean_scores_2[3], mean_scores_2[4]],
                   'Czułość': [mean_scores_3[0], mean_scores_3[1], mean_scores_3[2], mean_scores_3[3], mean_scores_3[4]]})
